...
$(function(){
	...
	function createHtml(c, key, congressUrl, sectionUrl) {
		var congress = "Congress: <a href="+ congressUrl + ">" + c + "</a><br/>"
		var section = "Section:  <a href="+ sectionUrl + ">" + key + "</a><br/>"
		return "<p>" + congress + section + "</p>"
	...
	function search() {
		...
		$.ajax({
			...
			success: function(data) {
					...
					if (congress instanceof Array) {
						for (var i=0; i < congress.length; i++) {
							...
							if (!(c in positions)) {
								...
								hmtlContent = hmtlContent + createHtml(c, key, congressUrl, sectionUrl); 
							}
				...
				$('#tabdata').attr('srcdoc', hmtlContent);
				$('#tabdata').show();
